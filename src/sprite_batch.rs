use sfml::graphics::{PrimitiveType, RenderStates, RenderTarget, Texture, Vertex, VertexArray};
...
impl SpriteBatch {
    ...
    pub fn add(&mut self, x: f32, y: f32, w: u32, h: u32, region: TextureRegion) {
        ...
        self.vertex_array
            .append(&Vertex::with_pos_coords(pos, tex_coord));
        ...
        let tex_coord = Vector2f::new(
            region.x as f32 + region.w as f32,
            region.y as f32 + region.h as f32,
        );
        self.vertex_array
            .append(&Vertex::with_pos_coords(pos, tex_coord));
